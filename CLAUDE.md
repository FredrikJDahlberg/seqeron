...
`registries.md` (the two shared namespaces core owns — `sourceId`, and the port blocks each repo
draws from), `portability-linux.md` (what a RHEL 9/10 bring-up has to fix — the tree is
macOS/clang-only today),
