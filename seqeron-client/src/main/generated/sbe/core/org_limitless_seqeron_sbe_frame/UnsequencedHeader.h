...
#ifndef _ORG_LIMITLESS_SEQERON_SBE_FRAME_UNSEQUENCEDHEADER_CXX_H_
#define _ORG_LIMITLESS_SEQERON_SBE_FRAME_UNSEQUENCEDHEADER_CXX_H_
...
public:
    ...
    UnsequencedHeader(
        ...
        const std::uint64_t bufferLength,
        const std::uint64_t actingVersion) :
        UnsequencedHeader(buffer, 0, bufferLength, actingVersion)
    {
    }
    ...
    UnsequencedHeader(
        char *buffer,
        const std::uint64_t bufferLength) :
        UnsequencedHeader(buffer, 0, bufferLength, sbeSchemaVersion())
    {
    }

    UnsequencedHeader &wrap(
        char *buffer,
        const std::uint64_t offset,
        const std::uint64_t actingVersion,
        const std::uint64_t bufferLength)
    ...
    UnsequencedHeader &sourceId(const std::int32_t value) SBE_NOEXCEPT
    {
    ...
    UnsequencedHeader &connectionId(const std::int32_t value) SBE_NOEXCEPT
    {
        std::int32_t val = SBE_LITTLE_ENDIAN_ENCODE_32(value);
    ...
    UnsequencedHeader &sessionId(const std::int64_t value) SBE_NOEXCEPT
    {
    ...
    UnsequencedHeader &payloadId(const std::uint16_t value) SBE_NOEXCEPT
    {
...
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, UnsequencedHeader &writer)
{
    builder << '{';
    builder << R"("sourceId": )";
