...
#ifndef _ORG_LIMITLESS_SEQERON_CLUSTER_SBE_SESSIONKEEPALIVE_CXX_H_
#define _ORG_LIMITLESS_SEQERON_CLUSTER_SBE_SESSIONKEEPALIVE_CXX_H_
...
public:
    ...
    SessionKeepAlive(char *buffer, const std::uint64_t bufferLength) :
        SessionKeepAlive(buffer, 0, bufferLength, sbeBlockLength(), sbeSchemaVersion())
    {
    }
    ...
    SessionKeepAlive(
        ...
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion) :
        SessionKeepAlive(buffer, 0, bufferLength, actingBlockLength, actingVersion)
    {
    }
    ...
    SessionKeepAlive &wrapForEncode(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        m_buffer = buffer;
        m_bufferLength = bufferLength;
        m_offset = offset;
    ...
    SessionKeepAlive &wrapAndApplyHeader(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
    ...
    SessionKeepAlive &wrapForDecode(
        char *buffer,
        const std::uint64_t offset,
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion,
    ...
    {
        SessionKeepAlive skipper(m_buffer, m_offset, m_bufferLength, m_actingBlockLength, m_actingVersion);
        skipper.skip();
    ...
    SessionKeepAlive &leadershipTermId(const std::int64_t value) SBE_NOEXCEPT
    {
    ...
    SessionKeepAlive &clusterSessionId(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
...
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, const SessionKeepAlive &_writer)
{
    SessionKeepAlive writer(
        _writer.m_buffer,
        _writer.m_offset,
    ...
    builder << '{';
    builder << R"("Name": "SessionKeepAlive", )";
