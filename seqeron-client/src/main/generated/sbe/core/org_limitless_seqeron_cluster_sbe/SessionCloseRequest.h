...
#ifndef _ORG_LIMITLESS_SEQERON_CLUSTER_SBE_SESSIONCLOSEREQUEST_CXX_H_
#define _ORG_LIMITLESS_SEQERON_CLUSTER_SBE_SESSIONCLOSEREQUEST_CXX_H_
...
public:
    ...
    SessionCloseRequest(char *buffer, const std::uint64_t bufferLength) :
        SessionCloseRequest(buffer, 0, bufferLength, sbeBlockLength(), sbeSchemaVersion())
    {
    }
    ...
    SessionCloseRequest(
        ...
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion) :
        SessionCloseRequest(buffer, 0, bufferLength, actingBlockLength, actingVersion)
    {
    }
    ...
    SessionCloseRequest &wrapForEncode(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        m_buffer = buffer;
        m_bufferLength = bufferLength;
        m_offset = offset;
    ...
    SessionCloseRequest &wrapAndApplyHeader(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
    ...
    SessionCloseRequest &wrapForDecode(
        char *buffer,
        const std::uint64_t offset,
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion,
    ...
    {
        SessionCloseRequest skipper(m_buffer, m_offset, m_bufferLength, m_actingBlockLength, m_actingVersion);
        skipper.skip();
    ...
    SessionCloseRequest &leadershipTermId(const std::int64_t value) SBE_NOEXCEPT
    {
    ...
    SessionCloseRequest &clusterSessionId(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
...
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, const SessionCloseRequest &_writer)
{
    SessionCloseRequest writer(
        _writer.m_buffer,
        _writer.m_offset,
    ...
    builder << '{';
    builder << R"("Name": "SessionCloseRequest", )";
