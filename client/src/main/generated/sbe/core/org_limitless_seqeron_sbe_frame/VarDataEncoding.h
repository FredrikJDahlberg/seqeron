...
#ifndef _ORG_LIMITLESS_SEQERON_SBE_FRAME_VARDATAENCODING_CXX_H_
#define _ORG_LIMITLESS_SEQERON_SBE_FRAME_VARDATAENCODING_CXX_H_
...
public:
    ...
    VarDataEncoding &length(const std::uint16_t value) SBE_NOEXCEPT
    {
