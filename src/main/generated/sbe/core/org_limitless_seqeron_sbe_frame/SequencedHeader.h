...
#ifndef _ORG_LIMITLESS_SEQERON_SBE_FRAME_SEQUENCEDHEADER_CXX_H_
#define _ORG_LIMITLESS_SEQERON_SBE_FRAME_SEQUENCEDHEADER_CXX_H_
...
public:
    ...
    SequencedHeader(
        ...
        const std::uint64_t bufferLength,
        const std::uint64_t actingVersion) :
        SequencedHeader(buffer, 0, bufferLength, actingVersion)
    {
    }
    ...
    SequencedHeader(
        char *buffer,
        const std::uint64_t bufferLength) :
        SequencedHeader(buffer, 0, bufferLength, sbeSchemaVersion())
    {
    }

    SequencedHeader &wrap(
        char *buffer,
        const std::uint64_t offset,
        const std::uint64_t actingVersion,
        const std::uint64_t bufferLength)
    ...
    SequencedHeader &sourceId(const std::int32_t value) SBE_NOEXCEPT
    {
    ...
    SequencedHeader &connectionId(const std::int32_t value) SBE_NOEXCEPT
    {
        std::int32_t val = SBE_LITTLE_ENDIAN_ENCODE_32(value);
    ...
    SequencedHeader &sessionId(const std::int64_t value) SBE_NOEXCEPT
    {
    ...
    SequencedHeader &payloadId(const std::uint16_t value) SBE_NOEXCEPT
    {
    ...
    SequencedHeader &globalSeqNo(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    SequencedHeader &timestamp(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
...
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, SequencedHeader &writer)
{
    builder << '{';
    builder << R"("sourceId": )";
