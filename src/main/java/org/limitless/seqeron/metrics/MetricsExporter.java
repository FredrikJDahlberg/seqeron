...
/**
 * Node-local Prometheus exporter (see {@code doc/ops.md}): serves seqeron's operator counters
 * ({@code SequencerService}/{@code ReplayerService}, see {@link SeqeronCounters}) as
...
public final class MetricsExporter {
     ...
     * SeqeronCounters#addAppCounter}). Emitted per counter instead, the second header line makes the
